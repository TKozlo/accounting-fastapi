...
class OperationsService:
    ...
    def create_list(self, user_id: int, operations_data: List[models.OperationCreate], ) -> List[tables.Operation]:
        operations = [
            tables.Operation(
                **operation_data.dict(),
                user_id=user_id,
    ...
    def create(self,user_id: int,operation_data: models.OperationCreate, ) -> tables.Operation:
    ...
    def update(self, user_id: int, operation_id: int, operation_data: models.OperationUpdate, ) -> tables.Operation:
        operation = self._get(user_id, operation_id)
